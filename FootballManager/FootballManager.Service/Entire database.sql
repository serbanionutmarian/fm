USE [master]
GO
/****** Object:  Database [FootballManager]    Script Date: 2/7/2015 10:15:30 AM ******/
...
USE [FootballManager]
GO
/****** Object:  User [UMTDEV\umt-users]    Script Date: 2/7/2015 10:15:30 AM ******/
CREATE USER [UMTDEV\umt-users] FOR LOGIN [UMTDEV\umt-users]
GO
ALTER ROLE [db_owner] ADD MEMBER [UMTDEV\umt-users]
GO
/****** Object:  StoredProcedure [dbo].[getRandomBoot]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[__MigrationHistory]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Countries]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[LeagesConfigurations]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
[MinOverallSkills] [int] NOT NULL,
[MaxOverallSkills] [int] NOT NULL,
PRIMARY KEY CLUSTERED
(
[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[Matches]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Players]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
[ATTR_LONG_SHOTS] [int] NOT NULL,
[ATTR_OFF_THE_BALL] [int] NOT NULL,
[ATTR_CREATIVITY] [int] NOT NULL,
...
[ATTR_AGGRESIVITY] [int] NOT NULL,
[ATTR_POSITIONING] [int] NOT NULL,
[ATTR_FREE_KICKS] [int] NOT NULL,
[ATTR_PENALTY] [int] NOT NULL,
[ATTR_CORNERS] [int] NOT NULL,
[ATTR_THROWINS] [int] NOT NULL,
[ATTR_AGILITY] [int] NOT NULL,
[ATTR_ACCELERATION] [int] NOT NULL,
[ATTR_SPEED] [int] NOT NULL,
[ATTR_STAMINA] [int] NOT NULL,
[ATTR_STRENGTH] [int] NOT NULL,
[ATTR_INJURY_PRONENESS] [int] NOT NULL,
[ATTR_BALANCE] [int] NOT NULL,
[ATTR_PASSING] [int] NOT NULL,
[ATTR_TEAMWORK] [int] NOT NULL,
[ATTR_CROSSING] [int] NOT NULL,
[ATTR_LEADERSHIP] [int] NOT NULL,
[ATTR_TENACITY] [int] NOT NULL,
[ATTR_HANDLING] [int] NOT NULL,
[ATTR_REFLEXES] [int] NOT NULL,
[ATTR_CONDITION] [int] NOT NULL,
[ATTR_MORALE] [int] NOT NULL,
[ATTR_FORM] [int] NOT NULL,
PRIMARY KEY CLUSTERED
(
[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Series]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Teams]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Users]    Script Date: 2/7/2015 10:15:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
